            ...
            <template v-slot="{ doc }">
                <div class="flex flex-col md:flex-row gap-2 items-start">
                    <div
                        ...
                        <h1
                            class="text-4xl tracking-tight font-bold font-sans text-black dark:text-white">
                            {{ doc.title }}
                        </h1>
                        <p
                        ...
                        <NuxtImg
                            loading="lazy"
                            :src="doc.img != '' ? doc.img : '/img/feature.jpg'"
                            class="w-full mb-4 cursor-pointer spotlight"
                            :data-src="
