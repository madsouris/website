        ...
        <ContentDoc>
            <template v-slot="{ doc }">
                <div class="flex flex-col md:flex-row gap-2 items-start">
                    <div
                        class="md:w-1/3 p-2 border border-gray-200 dark:border-gray-900 md:mb-2 md:sticky top-[112px]">
                        <NuxtLink
                            to="/projects"
                        ...
                        <h1
                            class="text-4xl tracking-tight font-bold font-sans text-black dark:text-white break-words">
                            {{ doc.title }}
                        </h1>
                        <p
                        ...
                        <img
                            ...
                            :src="
                                doc.img != ''
                                    ? doc.img
                                    : 'https://ik.imagekit.io/madsouris/vannrith/feature.jpg?tr=w-600'
                            "
                            class="w-full mb-4 spotlight cursor-pointer"
                            alt="Fatured" />
                        <ul>
                            <li>
                                Status:
                            ...
                            <li>
                                ...
                                <b>
                                    <a
                                        :href="'//' + doc.link"
                                        target="_blank"
                                        class="no-underline hover:text-orange-500"
                                        rel="no-follow">
                                        {{ doc.link }}
                                    </a>
                                </b>
